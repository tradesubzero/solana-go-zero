...
[![GoDoc](https://pkg.go.dev/badge/github.com/tradesubzero/solana-go-zero?status.svg)](https://pkg.go.dev/github.com/tradesubzero/solana-go-zero@v1.12.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/tradesubzero/solana-go-zero/releases)
[![Build Status](https://github.com/tradesubzero/solana-go-zero/workflows/tests/badge.svg?branch=main)](https://github.com/tradesubzero/solana-go-zero/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/tradesubzero/solana-go-zero/main)](https://www.tickgit.com/browse?repo=github.com/tradesubzero/solana-go-zero&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/tradesubzero/solana-go-zero)](https://goreportcard.com/report/github.com/tradesubzero/solana-go-zero)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/tradesubzero/solana-go-zero/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/tradesubzero/solana-go-zero@v1.12.0
```
...
You can wait for a transaction confirmation using the `github.com/tradesubzero/solana-go-zero/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/tradesubzero/solana-go-zero/programs/address-lookup-table"
...
import (
  ...
  "github.com/tradesubzero/solana-go-zero"
  "github.com/tradesubzero/solana-go-zero/programs/system"
  "github.com/tradesubzero/solana-go-zero/rpc"
...
import (
  ...
  "github.com/tradesubzero/solana-go-zero/rpc"
  "github.com/tradesubzero/solana-go-zero/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/tradesubzero/solana-go-zero/programs/system"
  "github.com/tradesubzero/solana-go-zero/rpc"
  confirm "github.com/tradesubzero/solana-go-zero/rpc/sendAndConfirmTransaction"
  "github.com/tradesubzero/solana-go-zero/rpc/jsonrpc"
  "github.com/tradesubzero/solana-go-zero/rpc/ws"
  "github.com/tradesubzero/solana-go-zero/text"
)
